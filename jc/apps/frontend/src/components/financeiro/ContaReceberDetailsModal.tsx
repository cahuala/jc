...
interface ContaReceberDetailsModalProps {
  conta: ContaReceber;
  onClose: () => void;
}

export default function ContaReceberDetailsModal({ conta, onClose }: ContaReceberDetailsModalProps) {
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col-sm-8">
                        <span className="fw-bold fs-5 text-success">Kz {conta.valor.toFixed(2)}</span>
                      </div>
                    </div>
                    <div className="row mb-3">
                      <div className="col-sm-4">
