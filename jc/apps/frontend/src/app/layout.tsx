  ...
  return (
    <div
      className={
        ...
        (settings.appHeaderFixed && !settings.appHeaderNone
          ? "app-header-fixed "
          : "") +
        ...
        (settings.appSidebarEndMobileToggled
...
export default function RootLayout({
  ...
  return (
    <html lang="pt" className={openSans.className}>
      <head>
        <title>Sistema de Justiça Militar Angolano</title>
      </head>
      <body>
        <AppSettingsProvider>
