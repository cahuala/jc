import { Calendar, Gauge, Fuel, Cog, MapPin, CheckCircle, Heart, Search, DollarSign } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#9fc031] focus:border-transparent outline-none bg-white"
                >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-1/2 px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#9fc031] focus:border-transparent outline-none"
                  />
                  <input
                    type="text"
                    placeholder="Max"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pl-10 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#9fc031] focus:border-transparent outline-none"
                  />
          ...
          {cars.map((car) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full bg-gradient-to-r from-[#005b52] to-[#007066] text-white py-3 rounded-lg hover:shadow-lg transition-all font-semibold">
                  Ver Detalhes
                </button>
              </div>
            </div>
